...
describe('POST /api/users/register', () => {
    describe('Input Sanitization Wiring', () => {
        test.concurrent(
            'return status 400 BAD REQUEST when email is not a valid email',
            async () => {
        ...
        test.concurrent(
            'return status 400 BAD REQUEST when a unexpected property is provided',
            async () => {
                const expectedStatus = 400;
    ...
    describe('Response', () => {
        test.concurrent(
            'return 201 CREATED and correct data (same data, no password, etc)',
            async () => {
