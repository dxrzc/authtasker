...
describe('Hashing Service', () => {
    describe('hash', () => {
        test.concurrent('return a hashed string', async () => {
        ...
        test.concurrent('produce different hashes for different inputs', async () => {
            const service = new HashingService(10);
        ...
        test.concurrent('produce different hashes for same input due to salting', async () => {
            const service = new HashingService(10);
    ...
    describe('compare', () => {
        test.concurrent('return true for valid data and its hash', async () => {
            const service = new HashingService(10);
