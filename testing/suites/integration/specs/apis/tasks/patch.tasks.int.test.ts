...
describe('PATCH /api/tasks/:id', () => {
    describe('Input Sanitization', () => {
        test('return 400 BAD REQUEST when a unexpected property is sent', async () => {
    ...
    describe('Modification Access Rules Wiring', () => {
        test("admins are forbidden to update other admin's tasks", async () => {
        ...
        test("admins are authorized to update editor's tasks", async () => {
            // Create admin
            const { sessionToken: currentUserSessionToken } = await createUser('admin');
    ...
    describe('Database operations', () => {
        ...
        describe('Duplicated Property Error Handling Wiring', () => {
            test('return 409 CONFLICT when task name already exists', async () => {
    ...
    describe('Response', () => {
        test('return status 200 and correct task data', async () => {
