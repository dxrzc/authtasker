...
describe('DELETE /api/tasks/:id', () => {
    describe('Modification Access Rules Wiring', () => {
        test("editors are forbidden to delete another editor's task", async () => {
        ...
        test("admins are authorized to delete editor's tasks", async () => {
            // Create admin
    ...
    describe('Database operations', () => {
        test('task is deleted in database', async () => {
