...
describe('DELETE /api/users/:id', () => {
    describe('Modification Access Rules Wiring', () => {
        test('editors are forbiddenn to delete readonly users', async () => {
        ...
        test('admins are authorized to delete readonly accounts', async () => {
            // Create current user
    ...
    describe('Tokens', () => {
        ...
        test('delete the user refresh tokens count set', async () => {
            // create assigns a refresh token
