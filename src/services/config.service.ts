...
export class ConfigService {
    ...
    public readonly MONGO_URI = env
        .get("MONGO_URI")
        .required()
        .asString();

    public readonly REDIS_URI = env
        .get("REDIS_URI")
        .required()
        .asString();
    ...
    public readonly JWT_REFRESH_EXP_TIME = env
        .get("JWT_REFRESH_EXP_TIME")
        .required()
        .asString();
    ...
    public readonly MAIL_SERVICE_PORT = env
    ...
    public readonly MAIL_SERVICE_PASS = env
        .get("MAIL_SERVICE_PASS")
        .required()
        .asString();

    public readonly WEB_URL = env
        .get("WEB_URL")
        .required()
        .asUrlString();

    public readonly HTTP_LOGS = env
        .get("HTTP_LOGS")
        .asBool();

    public readonly ADMIN_NAME = env
        .get("ADMIN_NAME")
        .required()
        .asString();

    public readonly ADMIN_EMAIL = env
        .get("ADMIN_EMAIL")
        .required()
        .asEmailString();

    public readonly ADMIN_PASSWORD = env
        .get("ADMIN_PASSWORD")
        .required()
        .asString();
    ...
    public readonly CACHE_HARD_TTL_SECONDS = env
        .get("CACHE_HARD_TTL_SECONDS")
        .required()
        .asInt();
